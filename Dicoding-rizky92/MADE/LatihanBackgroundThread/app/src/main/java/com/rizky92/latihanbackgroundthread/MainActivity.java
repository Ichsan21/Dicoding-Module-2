package com.rizky92.latihanbackgroundthread;
...
public class MainActivity extends AppCompatActivity implements MyAsyncCallBack {
    ...
    private final static String INPUT_STRING = "Hello there, DemoAsync Here! Kembali lagi bersama saya dalam...";
    ...
    private static class DemoAsync extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            MyAsyncCallBack myAsyncCallBack = this.myListener.get();
            if (myAsyncCallBack != null) {
                myAsyncCallBack.onPreExecute();
            }
        }
        ...
        protected void onPostExecute(String text) {
            ...
            MyAsyncCallBack myAsyncCallBack = this.myListener.get();
            if (myAsyncCallBack != null) {
                myAsyncCallBack.onPostExecute(text);
            }
        }
    }
}
