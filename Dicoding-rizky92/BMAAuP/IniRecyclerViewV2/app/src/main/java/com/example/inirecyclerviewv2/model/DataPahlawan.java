package com.example.inirecyclerviewv2.model;
...
public class DataPahlawan {
    private static String namaPahlawan[] = {
        "Ahmad Dahlan",
        "Ahmad Yani",
        "Sutomo",
        "Gatot Soebroto",
    ...
    private static String detailPahlawan[] = {
    ...
    private static int[] fotoPahlawan = {
    ...
    public static ArrayList<Pahlawan> getListData() {
        ...
        for (int i = 0; i < namaPahlawan.length; i++) {
            Pahlawan pahlawan = new Pahlawan();
            pahlawan.setNama(namaPahlawan[i]);
            pahlawan.setDetail(detailPahlawan[i]);
            pahlawan.setFoto(fotoPahlawan[i]);
            list.add(pahlawan);
        }
        return list;
    }
